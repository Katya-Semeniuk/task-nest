          ...
          <Row className="mb-3">
            <Col>
              <Form.Group controlId="description">
                <Form.Label className={styles.TextBlue}>Description:</Form.Label>
                <Form.Control
                  as="textarea"
                  rows={3}
                  name="description"
          ...
          <Row className="mb-3">
            <Col>
              <Form.Group controlId="assigned_to">
                <Form.Label className={styles.TextBlue}>Assigne to:</Form.Label>
                <p>To select multiple participants, press Ctrl and select the name</p> 
                <Form.Control
                  as="select"
                  multiple
                  name="assigned_to"
